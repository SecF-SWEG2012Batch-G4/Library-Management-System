 ...
 struct bookinfo
{
 ...
 { new bookinfo[totalBooks] {
            {"harry potter","Fiction",{12,23,2004},"J.K Rowlings",5,1001,4.8,true},
            {"Fundamentals of Fluid Mechanics","Educational",{30,9,2017},"Bruce Roy Munson",2,1002,3.9,true},
            {"Introduction To Computing","Educational",{02,12,2019},"Steven C Chapra",6,1003,2.3,true},
            {"Materials science ","Educational",{23,8,2021},"Steven C Chapra",2,1004,5,true},
            {"Perfect Chemistry","Romance",{28,02,2019},"Simone Elkeles",1,1005,4.8,true},
            {"Dune","Romance",{05,17,2017},"Frank Herbert",9,1006,4.1,true},
            {"Hamlet","Drama",{00,00,1601},"William Shakespeare",10,1007,4.6,true}
			}};
