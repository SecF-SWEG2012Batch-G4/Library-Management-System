...
Menu2:  cout<< " \t Do you want to borrow this book. Press 'Y' for Yes and 'N' for No "<<endl;
        ...
        if (option == 'Y'|| option == 'y'){
          book_info[i].status=1;
            ...
            cin>>book_info[i].due_date.dd>>book_info[i].due_date.mm>>book_info[i].due_date.yy;
            cout<<endl;
...
case 3: {
        ...
        for (int i= 0; i<totalBooks; i++){
            ...
            {
                cout<<setw(10)<< book_info[i].studid<<setw(40)<< book_info[i].name<<setw(30)<< book_info[i].author<<setw(20)<<book_info[i].due_date.dd<<"/"<<book_info[i].due_date.mm<<"/"<<book_info[i].due_date.yy<<endl;
            }
